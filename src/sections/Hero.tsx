...
const SmallStat = ({ label, value }: { label: string; value: string }) => (
  ...
  >
    ...
    <Text fw={800} size="sm" style={{ color: "white" }}>
      {value}
    </Text>
    <Text size="8px" c="dimmed" fw={700} style={{ textTransform: "uppercase" }}>
      {label}
    </Text>
  </Box>
);
      ...
      <Group justify="space-between" align="center" wrap="wrap" gap={50}>
        <Stack gap="lg" style={{ flex: 1, minWidth: "300px" }}>
          ...
          <Box style={{ textAlign: "center" }} ta={{ md: "left" }}>
            ...
            >
              Lift your Business <br /> to{" "}
              <span style={{ color: "#2DD4BF" }}>New Heights</span> <br />
              <Text component="span" inherit visibleFrom="sm">
                with Our Online Success
              </Text>
            </Title>
            <Text
              size="md"
              mt="lg"
              style={{ color: "#777", maxWidth: 450, margin: "0 auto" }}
              mx={{ md: "0" }}
            >
              Your Brand's Online Success Starts Here. Transforming businesses
              into market leaders.
            </Text>
          </Box>
          <Group
          ...
          >
            ...
            >
              <Group justify="space-between" mb={30}>
                ...
                <Badge variant="outline" color="emerald.5" size="xs">
                  Live Dashboard
                </Badge>
              </Group>
              ...
              <Box mt={30} style={{ height: "80px" }}>
                <svg
                  viewBox="0 0 400 100"
                  style={{ width: "100%", height: "100%" }}
                >
                  <path
                    d="M0 80 Q 100 20 200 60 T 400 30"
                    fill="none"
                    stroke="#10B981"
                    strokeWidth="3"
                  />
