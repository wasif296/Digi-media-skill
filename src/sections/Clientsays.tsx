...
const testimonials = [
  {
    ...
    content:
      "Their social media strategy filled our restaurant every night. The ROI has been incredible.",
    image:
  ...
  },
  {
    ...
    content:
      "Digi Media Skills transformed our property listings into lead-generating machines. Best in Pakistan!",
    image:
  ...
  },
  {
    ...
    content:
      "The custom web design they provided is not only beautiful but extremely fast.",
    image:
  ...
  },
  {
    ...
    content:
      "Building trust online for tax services is hard, but they made it look easy. Highly recommended!",
  ...
  },
  {
    ...
    content:
      "From branding to SEO, they handled everything. Our dealership's online presence is now very strong.",
    ...
    <Box py={80} style={{ background: "#020408" }}>
      <Container size="lg">
        <Stack align="center" mb={50} gap={5}>
          ...
          >
            <Text
              size="xs"
              fw={800}
              style={{ color: "#10B981", letterSpacing: 2 }}
            >
              TESTIMONIALS
            </Text>
          </Box>
        ...
        <motion.div whileHover={{ y: -5 }} transition={{ duration: 0.3 }}>
          ...
          >
            <Box
              style={{ position: "absolute", top: 30, left: 30, opacity: 0.1 }}
            >
            ...
            <AnimatePresence mode="wait">
              ...
              >
                <Stack align="center" gap="lg">
                  ...
                  <Box>
                    <Text fw={900} size="lg" style={{ color: "white" }}>
