    ...
    <Box py={100} id="portfolio" style={{ background: "#020408" }}>
      <Container size="lg">
        <Box mb={70} style={{ textAlign: "center" }}>
          <Badge variant="dot" color="emerald" size="lg" mb="md">
            OUR IMPACT
          </Badge>
          <Title
            order={2}
          ...
          >
            Real Results for{" "}
            <span style={{ color: "#10B981" }}>Real Businesses</span>
          </Title>
        </Box>
                  ...
                  >
                    ...
                    >
                      <Group justify="space-between">
                        <Badge variant="outline" color="emerald" size="xs">
                          {p.category}
                        </Badge>
                        <Badge color="emerald" radius="xl" variant="filled">
                          {p.result}
                        </Badge>
                      </Group>
