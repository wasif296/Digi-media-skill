        ...
        <Group justify="space-between" align="flex-start" wrap="wrap" gap={60}>
          <Box style={{ flex: 1.2, minWidth: "300px" }}>
            ...
            >
              ...
              >
                Leading Digital Marketing <br /> Agency in{" "}
                <span style={{ color: "#2DD4BF" }}>Pakistan</span>
              </Title>
              ...
              <Text
                ...
                c="dimmed"
                size="md"
                style={{ lineHeight: 1.6, maxWidth: "600px" }}
              >
                Transforming Local/International Small Businesses into Market
                Leaders. We are not just an agency; we are your business partner
                in growth.
              </Text>
              <Text
                mt="md"
                c="dimmed"
                size="sm"
                style={{ lineHeight: 1.6, maxWidth: "600px", opacity: 0.6 }}
              >
                With a decade of expertise and a passion for innovation, we
                craft digital strategies that don't just meet expectations—they
                exceed them.
              </Text>
