...
const LoginPage = () => {
  ...
  const form = useForm({
    ...
    validate: {
      email: (value) =>
        /^\S+@\S+$/.test(value) ? null : "Invalid professional email",
      password: (value) =>
        value.length < 6 ? "Security threshold not met" : null,
    },
  });
          ...
          >
            <Group gap="md">
              ...
              <Box>
                ...
                >
                  Digi Media <span style={{ color: "#10B981" }}>SKILLS</span>
                </Title>
                <Text
                  size="8px"
                  fw={800}
        ...
        >
          ...
          >
            <Stack align="center" gap={5} mb={30}>
              ...
              <Title order={3} style={{ color: "white", fontWeight: 800 }}>
                Admin Portal
              </Title>
              <Text
                size="xs"
